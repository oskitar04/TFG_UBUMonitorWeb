...
@Component
public class AffectedUserIdCollumFillStrategy implements ColumnFillStrategy {

    @Override
    public LogHeaderDto getHeaderName() {
        return LogHeaderDto.AFFECTED_USER_ID;
    }

    @Override
    public Object fill(String currentValue, Map<String, String> row, Map<String, Object> descriptionValues) {

        return descriptionValues.get("target_user_id");
    }
